...
#NOTIFY_MISSING_PERMISSIONS = ("タイマーの作成を許可してください。")
...
#            ).response          
            ...
            #return handler_input.response_builder.speak("タイマー権限を付けてください。").set_card(AskForPermissionsConsentCard(permissions=["alexa::alerts:timers:skill:readwrite"])).response
...
#           # logger.error('3')
            ...
            #)
#        else:
#            logger.error('権限が見つかりました：' + user_permissions.consent_token)
#        logger.error('4')
        ...
        if attributes_exist:
            ...
            speak_output = speak_output + "前回は {RiceAmount}合炊きましたね。".format(RiceAmount=str(RiceAmount))
        #else:
        #    speak_output = speak_output
        speak_output = speak_output + "何合炊きますか？"
        
        #speak_output = "Welcome, you can say Hello or Help. Which would you like to try?"
        #speak_output = "土鍋タイマーへようこそ。何合炊きますか？"
        reprompt_output = "何合炊きますか？"
        return (
            handler_input.response_builder
                .speak(speak_output)
                .ask(reprompt_output)
...
class CaptureRiceAmountIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = str(RiceAmount) + "合ですね。お水は" + str(int(round(WaterAmount,-1))) + "ミリリットル入れてください。"
...
#        speak_output = str(RiceAmount) + "合ですね。"
#        speak_output =  "合ですね。"
        return (
            handler_input.response_builder
                .speak(speak_output)
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speak_output = "ごめんなさい。よくわかりません。もう一度お願いします。"
